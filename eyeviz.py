...
# h5f = h5py.File(h5files[0],'r')
def ploteye(h5f,patient='070',eyeside='L',t=0,gridpts=640,tness='GCIPL',
    ...
    if len(h5f.keys()) == 0:
        ...
        ax.text(36,0.5*totalheight,'OCT',rotation='vertical',fontsize=16)
        ax.text(47,0.1*totalheight,'VF difference from baseline',rotation='vertical',fontsize=16)
